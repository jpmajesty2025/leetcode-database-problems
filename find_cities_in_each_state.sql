...
-- The PostgreSQL / DuckDB Method (STRING_AGG with Inline ORDER BY)
-- Concatenates city names per state into a comma-separated string sorted alphabetically.
-- Returns native unbounded TEXT type, avoiding silent string truncation.
SELECT 
    state, 
